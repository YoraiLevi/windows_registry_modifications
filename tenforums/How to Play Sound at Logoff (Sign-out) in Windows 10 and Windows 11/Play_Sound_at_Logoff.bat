...
:: ************************************************************************************
@echo off & Title Play a sound at Logoff (Sign-out) & mode con cols=90 lines=19 & color 17
...
echo.
:Enter_the_path
SET /P "【Path】= --> Please key in (or copy and paste) the full path (without quotation marks) of the .wav     sound file you want to be played (for example,                                            C:\Windows\Media\Windows Logoff Sound.wav) and then press [Enter]:                        " 
...
Set "【Task】=TenForums\Play logoff sound"
...
%W%"<Subscription>&lt;QueryList&gt;&lt;Query Id=""0"" Path=""Security""&gt;&lt;Select Path=""Security""&gt;*[System[EventID=4647]]&lt;/Select&gt;&lt;/Query&gt;&lt;/QueryList&gt;</Subscription>"
%W%"</EventTrigger>"
%W%"</Triggers>"
%W%"<Principals>"
...
echo    ====================================================================================
echo       The script has failed to create the task "Play logoff sound".
...
echo    ====================================================================================
echo       The task "Play logoff sound" is in "Task Scheduler Library"--^>"TenForums".
