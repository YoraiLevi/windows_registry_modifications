...
:: ************************************************************************************
@echo off & Title Play a sound at Logon (Sign-in) & mode con cols=90 lines=19 & color 17
...
Set "【Task】=TenForums\Play logon sound"
...
%W%"<Enabled>true</Enabled>"
%W%"<StateChange>ConsoleConnect</StateChange>"
%W%"</SessionStateChangeTrigger>"
%W%"</Triggers>"
%W%"<Principals>"
...
echo    ====================================================================================
echo       The script has failed to create the task "Play logon sound".
...
echo    ====================================================================================
echo       The task "Play logon sound" is in "Task Scheduler Library"--^>"TenForums".
