...
:: https://www.tenforums.com/tutorials/94932-how-play-sound-when-unlock-computer-windows.html
:: ************************************************************************************
@echo off & Title Play Sound when Unlock Computer & mode con cols=90 lines=19 & color 17
...
Set "【Task】=TenForums\Play unlock sound"
...
%W%"<StateChange>SessionUnlock</StateChange>"
%W%"</SessionStateChangeTrigger>"
%W%"</Triggers>"
%W%"<Principals>"
...
echo    ====================================================================================
echo       The script has failed to create the task "Play unlock sound".
...
echo    ====================================================================================
echo       The task "Play unlock sound" is in "Task Scheduler Library"--^>"TenForums".
