...
:: https://www.tenforums.com/tutorials/127426-disable-integrated-camera-webcam-windows.html
:: ****************************************************************************************
@echo off & title Turn on or off the camera. & mode con cols=80 lines=13 & color 17
(Net session >nul 2>&1)||(PowerShell start """%~0""" -verb RunAs & Exit /B)
:: ****************************************************************************************
Set "【Item】=Camera on/off (toggle)"
...
(
echo :: This script was created by Matthew Wai at www.TenForums.com/members/matthew-wai.html
echo :: https://www.tenforums.com/tutorials/127426-disable-integrated-camera-webcam-windows.html
echo :: ****************************************************************************************
